      ...
      <section className="pt-20 pb-0 bg-surface">
        <div className="container mx-auto px-6 text-center max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center mb-10">
            <Link href="/services#account-community" className="inline-block bg-transparent text-black hover:bg-red-500 hover:text-white px-4 py-2 border border-red-200 text-sm shadow-md rounded transition-smooth focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 text-center font-medium -mt-2 z-10">Account/Community Management</Link>
            <Link href="/services#content-strategy" className="inline-block bg-transparent text-black hover:bg-red-500 hover:text-white px-4 py-2 border border-red-200 text-sm shadow-md rounded transition-smooth focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 text-center font-medium -mt-2 z-10">Content Strategy</Link>
            <Link href="/services#digital-marketing" className="inline-block bg-transparent text-black hover:bg-red-500 hover:text-white px-4 py-2 border border-red-200 text-sm shadow-md rounded transition-smooth focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 text-center font-medium -mt-2 z-10">Digital Marketing</Link>
            <Link href="/services#product-marketing" className="inline-block bg-transparent text-black hover:bg-red-500 hover:text-white px-4 py-2 border border-red-200 text-sm shadow-md rounded transition-smooth focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 text-center font-medium -mt-2 z-10">Product Marketing</Link>
          </div>
