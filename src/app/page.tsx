                   ...
                   <>
                     ...
                     <div className="w-full md:w-1/2 text-center md:text-left">
                       ...
                       <div className="flex flex-col gap-2 mb-4">
                        ...
                        <a href={index === 0 ? 'https://redkitecandy.com' : index === 1 ? 'https://replom.com' : `/projects/${project.slug}`} target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-3 bg-primary text-surface rounded hover:bg-primary/80">Learn More</a>
                     </div>
                   </>
                 ) : (
                  <>
