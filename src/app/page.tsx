                 ...
                 {index % 2 === 0 ? (
                   <>
                     ...
                     <div className="w-full md:w-1/2 text-center md:text-left">
                       ...
                       <Link href={project.slug === 'red-kite-candy' ? 'https://redkitecandy.com' : project.slug === 'replom' ? 'https://replom.com' : `/projects/${project.slug}`} target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-3 bg-primary text-surface rounded hover:bg-primary/80">Learn More</Link>
                     </div>
                   </>
                 ) : (
                  <>
