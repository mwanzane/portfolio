      ...
      <section className="pt-20 pb-0 bg-surface">
        <div className="container mx-auto px-6 text-center max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center mb-10">
            <Button href="/services#account-community" className="bg-transparent text-black hover:bg-red-500 hover:text-white px-4 py-2 border border-red-200 text-sm shadow-md -mt-2 z-10">Account/Community Management</Button>
            <Button href="/services#content-strategy" className="bg-transparent text-black hover:bg-red-500 hover:text-white px-4 py-2 border border-red-200 text-sm shadow-md -mt-2 z-10">Content Strategy</Button>
            <Button href="/services#digital-marketing" className="bg-transparent text-black hover:bg-red-500 hover:text-white px-4 py-2 border border-red-200 text-sm shadow-md -mt-2 z-10">Digital Marketing</Button>
            <Button href="/services#product-marketing" className="bg-transparent text-black hover:bg-red-500 hover:text-white px-4 py-2 border border-red-200 text-sm shadow-md -mt-2 z-10">Product Marketing</Button>
          </div>
